    ...
    <main className="create-post-page">
      ...
      <div className="form-container">
        <form onSubmit={submitHandler}>
            <label className="post" htmlFor="postImage">
              ...
              <div className="btn">Select from computer</div>
            </label>
            <input hidden type="file" name="postImage" id="postImage" ref={postImageinputFeildRef} />
